...
class Recipe(Base):
    ...
    def __str__(self):
        return "ID: " + str(self.id) + " Name: " + str(self.name) + " Ingredients: " + str(self.ingredients) + " Cooking Time " + str(self.cooking_time) + " Difficulty: " + str(self.difficulty)
...
def search_by_ingredients():
    ...
    if session.query(Recipe).count() == 0:
        ...
        search_ingredients = [all_ingredients[int(i) - 1] for i in numbers_of_ings] 
